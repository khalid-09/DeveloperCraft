  ...
  return (
    <>
      ...
      <div className="relative z-50 mt-3 transition duration-300 ease-in">
        <div className="z-50 block w-[55%] rounded-3xl border-y-2 border-neutral-700 bg-mainBg shadow-md  transition duration-300 ease-in dark:bg-lightBg  sm:w-[40%] md:hidden">
