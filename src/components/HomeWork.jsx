    ...
    <>
      ...
      >
        {!work ? (
          ...
          <div className="ml-2 mt-2 flex w-28  items-center justify-start gap-3 rounded-full border border-stone-700 px-4 py-1">
            <img src={workAllIcon} alt="project-icon" height={20} width={20} />
            <p className="font-railway  ">All</p>
            <span className="text-lg text-stone-700">{projectData.length}</span>
          </div>
        )}
