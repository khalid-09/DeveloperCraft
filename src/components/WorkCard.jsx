  ...
  return (
    <div>
      <div className="mt-4 flex gap-4 p-2">
        ...
        <div className="flex w-full flex-col gap-2">
          ...
          <p className="font-libre">
            ...
            <Link
              to="/work"
              className="font-poppins italic text-white opacity-50 hover:underline"
            >
              Learn More &rarr;
            </Link>
          </p>
      ...
      <ul className="flex gap-2 border-b-2 border-[#57534e] p-2 font-poppins ">
        {skills.map((skill) => (
          <li
            className="rounded-full bg-lightBg px-2 py-1  text-sm text-white hover:scale-105 dark:bg-mainBg md:px-2"
            key={skill.skillName}
          >
